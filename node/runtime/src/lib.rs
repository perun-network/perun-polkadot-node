...
use sp_runtime::traits::{
    AccountIdLookup, BlakeTwo256, Block as BlockT, IdentifyAccount, Keccak256, NumberFor, Verify,
};
use sp_runtime::{
...
parameter_types! {
    ...
    pub const PerunMinDeposit: u64 = 10;
}

/// Configure the pallet-perun in pallets/pallet-perun.
